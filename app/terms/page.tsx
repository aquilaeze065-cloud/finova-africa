    ...
    <>
      ...
      <div className="legal-bg">
        ...
        {[
          ...
          {h:"4. Returns & Interest", p:"NEXORA offers a 35% Annual Percentage Yield (APY) on weekly contributions. A $15 cash/food voucher is awarded upon successful completion of all 52 weeks. Total projected payout is $165.80. Returns are not guaranteed and may vary based on market conditions."},
