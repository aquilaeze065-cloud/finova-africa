...
const NEXORA_FAQ = [
  ...
  { q:["referral","refer","invite","referral code","bonus"], a:"You get a unique referral code when you sign up! Share it with friends. When they register using your code, you earn a $1 USDT referral bonus credited to your account automatically." },
